...
<head>
    <title>KipawaIsp Installer</title>
...
<body style='background-color: #FBFBFB;'>
    <div id='main-container'>
        ...
        <hr>
        <div class="span12">
            <h4> KipawaIsp Installer </h4>
            <p>
                <strong>Congratulations!</strong><br>
                You have just installed KipawaIsp !<br><br>
                <span class="text-danger">But wait!!<br>
                    <ol>
                        ...
                        <li>Activate <a href="https://github.com/hotspotbilling/kipawaisp/wiki/Cron-Jobs" target="_blank">Cronjob</a> for Expired and Reminder.</li>
                        <li>Check <a href="https://github.com/hotspotbilling/kipawaisp/wiki/How-It-Works---Cara-kerja" target="_blank">how KipawaIsp Works</a></li>
                        <li><a href="https://github.com/hotspotbilling/KipawaIsp/wiki#login-page-mikrotik" target="_blank">how to link Mikrotik Login to KipawaIsp</a></li>
                        <li>or use <a href="https://github.com/hotspotbilling/KipawaIsp-mikrotik-login-template" target="_blank">Mikrotik Login Template for KipawaIsp</a></li>
                    </ol>
                </span><br><br>
    ...
    <div class="footer">Copyright &copy; 2025 KipawaIsp. All Rights Reserved<br /><br /></div>
</body>
