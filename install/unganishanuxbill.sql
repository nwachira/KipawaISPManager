...
--
DROP TABLE IF EXISTS tbl_banks;  -- Add this line at the very beginning of your SQL file
...
--
DROP TABLE IF EXISTS tbl_payments_page;
...
--
DROP TABLE IF EXISTS tbl_recharge_cards;
...
--
DROP TABLE IF EXISTS tbl_recharge_lock;
...
ALTER TABLE `tbl_customers` ADD `router_id` VARCHAR(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci AFTER `auto_renewal`;

ALTER TABLE `tbl_payment_gateway` ADD `mac_address` VARCHAR(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci AFTER `routers_id`;


ALTER TABLE tbl_payment_gateway
ADD checkout VARCHAR(50);
